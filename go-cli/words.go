...
func registerSDKWords(r *eng.Registry, client *sdk.TransportSDK) {
...
func runOp(client *sdk.TransportSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
