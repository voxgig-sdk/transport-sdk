...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/transport` | `npm install @voxgig-sdk/transport` |
| Python | `voxgig-sdk-transport` | `pip install voxgig-sdk-transport` |
| PHP | `voxgig-sdk/transport` | `composer require voxgig-sdk/transport` |
| Golang | `github.com/voxgig-sdk/transport-sdk/go` | `go get github.com/voxgig-sdk/transport-sdk/go` |
| Ruby | `voxgig-sdk-transport` | `gem install voxgig-sdk-transport` |
| Lua | `voxgig-sdk-transport` | `luarocks install voxgig-sdk-transport` |
