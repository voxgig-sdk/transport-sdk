...
class TransportFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TransportSDK/1.0)';
    ...
    public static function call(TransportContext $ctx, string $fullurl, array $fetchdef): array
    {
