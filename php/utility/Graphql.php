...
class TransportGraphql
{
    ...
    // equivalent.
    public static function body(TransportContext $ctx): mixed
    {
    ...
    public static function errors(TransportContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
