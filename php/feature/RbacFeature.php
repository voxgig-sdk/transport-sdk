...
class TransportRbacFeature extends TransportBaseFeature
{
    ...
    private function _required(TransportContext $ctx): ?string
    {
    ...
    private function _reject(TransportContext $ctx, string $required): void
    {
    ...
    private function _track(TransportContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
