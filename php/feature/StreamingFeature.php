...
// Transport SDK streaming feature
...
class TransportStreamingFeature extends TransportBaseFeature
{
    ...
    private function _iterate(TransportResult $result): \Generator
    {
    ...
    private function _streamable(TransportContext $ctx): bool
    {
