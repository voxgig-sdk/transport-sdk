...
class TransportTimeoutFeature extends TransportBaseFeature
{
    ...
    private function _with_timeout(TransportContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TransportContext $_ctx, float $ms): void
    {
        $client = $this->client;
