...
// Transport SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TransportSDK::test)
...
{
    private const SDK_CLASS = 'TransportSDK';
    ...
    private const SDK_BASE = 'transport_sdk';
