...
class TransportTestRunner
{
    ...
    {
        $live = self::getenv('TRANSPORT_TEST_LIVE');
        $override = self::getenv('TRANSPORT_TEST_OVERRIDE');
        ...
        $explain = self::getenv('TRANSPORT_TEST_EXPLAIN');
...
class_alias('TransportTestRunner', 'Runner');
class_alias('TransportHelpers', 'Helpers');
