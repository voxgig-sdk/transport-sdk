...
class StationboardDirectTest extends TestCase
{
    public function test_direct_list_stationboard(): void
    {
        $setup = stationboard_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-stationboard", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
