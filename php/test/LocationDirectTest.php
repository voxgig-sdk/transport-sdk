...
class LocationDirectTest extends TestCase
{
    public function test_direct_list_location(): void
    {
        $setup = location_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-location", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
