...
// Transport SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = TransportOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(TransportOmni::structfix($now, Struct::undef()))
                        !== json_encode(TransportOmni::structfix($val, Struct::undef()))) {
