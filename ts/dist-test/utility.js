...
function envOverride(m) {
    if ('TRUE' === process.env.TRANSPORT_TEST_LIVE ||
        'TRUE' === process.env.TRANSPORT_TEST_OVERRIDE) {
    ...
    m.TRANSPORT_TEST_EXPLAIN = process.env.TRANSPORT_TEST_EXPLAIN || m.TRANSPORT_TEST_EXPLAIN;
    return m;
}
