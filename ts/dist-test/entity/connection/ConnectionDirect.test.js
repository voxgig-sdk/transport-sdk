...
(0, node_test_1.describe)('ConnectionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-connection', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-connection', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TRANSPORT_TEST_CONNECTION_ENTID'];
...
//# sourceMappingURL=ConnectionDirect.test.js.map