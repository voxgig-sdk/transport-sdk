...
(0, node_test_1.describe)('LocationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-location', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-location', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TRANSPORT_TEST_LOCATION_ENTID'];
...
//# sourceMappingURL=LocationDirect.test.js.map