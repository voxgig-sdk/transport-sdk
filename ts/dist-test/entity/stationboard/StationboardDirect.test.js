...
(0, node_test_1.describe)('StationboardDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.TransportSDK({
    ...
    (0, node_test_1.test)('direct-list-stationboard', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-stationboard', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.TRANSPORT_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.TransportSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['TRANSPORT_TEST_STATIONBOARD_ENTID'];
    ...
    const client = new __1.TransportSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=StationboardDirect.test.js.map