...
class ConnectionEntity extends TransportEntityBase_1.TransportEntityBase {
    constructor(client, entopts) {
        super(client, entopts);
        this.name = 'connection';
        this.name_ = 'connection';
        this.Name = 'Connection';
    }
    make() {
        return new ConnectionEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<Connection[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
