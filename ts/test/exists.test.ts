...
describe('exists', async () => {
  ...
  //
  // TransportSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof TransportSDK, true,
      'TransportSDK.test() must return a client synchronously')
  })
