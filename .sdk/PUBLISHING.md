...
|---|---|---|
| `ts/` | @voxgig-sdk/transport-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/transport-sdk \
      --repository voxgig-sdk/transport-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/transport-sdk` shows it, and
`npm trust revoke @voxgig-sdk/transport-sdk --id=<id>` removes it.
