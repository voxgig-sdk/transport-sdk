...
// Transport SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class TransportTransformResponse
{
    public static function call(TransportContext $ctx): mixed
    {
        ...
        $transform = TransportHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
