...
// Transport SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class TransportMakeRequest
{
    public static function call(TransportContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new TransportResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new TransportResponse($fetched);
        } else {
