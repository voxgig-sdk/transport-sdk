...
class TransportCacheFeature extends TransportBaseFeature
{
    ...
    private function _through(TransportContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
