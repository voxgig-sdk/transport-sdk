...
class TransportProxyFeature extends TransportBaseFeature
{
    ...
    public function init(TransportContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (TransportContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
