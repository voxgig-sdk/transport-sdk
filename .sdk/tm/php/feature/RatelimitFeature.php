...
// Transport SDK ratelimit feature
...
class TransportRatelimitFeature extends TransportBaseFeature
{
    ...
    private function _acquire(TransportContext $ctx): void
    {
    ...
    private function _track(TransportContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
