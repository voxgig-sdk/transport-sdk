...
// Transport SDK clienttrack feature
...
class TransportClienttrackFeature extends TransportBaseFeature
{
    ...
    public function PostConstruct(TransportContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Transport-SDK';
