...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = TransportOmni.make_runner(TEST_JSON_FILE, TransportSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : TransportOmni.errify(err)
    end
