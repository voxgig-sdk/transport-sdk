...
from projectname_sdk.core.control import TransportControl
...
class TransportContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, TransportSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, TransportResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, TransportResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return TransportError(code, msg, self)
