...
from projectname_sdk import TransportSDK
from projectname_sdk.core.spec import TransportSpec
from projectname_sdk.core.result import TransportResult
from projectname_sdk.core.response import TransportResponse
from projectname_sdk.core.operation import TransportOperation
from projectname_sdk.core.error import TransportError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import TransportBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return TransportError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = TransportSDK.test(None, None)
        ...
        class TestInitFeature(TransportBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(TransportBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = TransportSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = TransportSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = TransportSDK.test(None, setup_opts)
