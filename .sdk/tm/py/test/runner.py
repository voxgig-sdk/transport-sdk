...
class TransportTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TransportTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = TransportTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = TransportTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
