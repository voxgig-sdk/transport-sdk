...
class TransportTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TransportTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = TransportTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = TransportTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
