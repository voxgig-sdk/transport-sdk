# Transport SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TransportSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TransportSDK(...) and TransportSDK.test(...) become
#      TransportSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "transport_sdk"
_SDK_CLASS = "TransportSDK"
