...
from transport_sdk.utility import register

# Load features
from transport_sdk.feature.base_feature import TransportBaseFeature
from transport_sdk.features import _has_feature, _make_feature
...
class TransportSDK:
    ...
    def get_utility(self):
        return TransportUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("TransportSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Connection(self, data=None) -> "ConnectionEntity":
        ...
        from transport_sdk.entity.connection_entity import ConnectionEntity
    ...
    def Location(self, data=None) -> "LocationEntity":
        ...
        from transport_sdk.entity.location_entity import LocationEntity
    ...
    def Stationboard(self, data=None) -> "StationboardEntity":
        ...
        from transport_sdk.entity.stationboard_entity import StationboardEntity
