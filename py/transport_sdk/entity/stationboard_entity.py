...
from transport_sdk.transport_types import (
    Stationboard,
...
class StationboardEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return StationboardEntity(self._client, opts)
    ...
    def data_get(self) -> Stationboard:
    ...
    def match_get(self) -> Stationboard:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Stationboard]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Stationboard().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
