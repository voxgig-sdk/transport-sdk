...
describe("StationboardDirect", function()
  it("should direct-list-stationboard", function()
    local setup = stationboard_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-stationboard", setup.live and "live" or "unit")
...
function stationboard_direct_setup(mockres)
