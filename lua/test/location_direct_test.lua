...
describe("LocationDirect", function()
  it("should direct-list-location", function()
    local setup = location_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-location", setup.live and "live" or "unit")
...
function location_direct_setup(mockres)
