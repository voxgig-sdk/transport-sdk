...
describe("ConnectionDirect", function()
  it("should direct-list-connection", function()
    local setup = connection_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-connection", setup.live and "live" or "unit")
...
function connection_direct_setup(mockres)
