...
local TransportSDK = {}
TransportSDK.__index = TransportSDK
...
TransportSDK._make_feature = _make_feature


function TransportSDK.new(options)
  local self = setmetatable({}, TransportSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function TransportSDK:options_map()
...
function TransportSDK:get_utility()
  return Utility.copy(self._utility)
end


function TransportSDK:get_root_ctx()
  return self._rootctx
end


function TransportSDK:prepare(fetchargs)
...
function TransportSDK:direct(fetchargs)
...
-- by passing it.
function TransportSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function TransportSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "TransportSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function TransportSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = TransportSDK.new(sdkopts)
  sdk.mode = "test"
