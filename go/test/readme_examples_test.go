...
const testSeed = `map[string]any{"entity": map[string]any{"connection": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "location": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "stationboard": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
