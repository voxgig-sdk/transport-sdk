...
func (sdk *TransportSDK) OptionsMap() map[string]any {
...
func (sdk *TransportSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *TransportSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *TransportSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TransportSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *TransportSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *TransportSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("TransportSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *TransportSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TransportSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("TransportSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
