...
type StationboardEntity struct {
	name    string
	client  *core.TransportSDK
...
func NewStationboardEntity(client *core.TransportSDK, entopts map[string]any) *StationboardEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *StationboardEntity) GetName() string { return e.name }
...
func (e *StationboardEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *StationboardEntity) Deleted() bool {
	return e.deleted
}


func (e *StationboardEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewStationboardEntity(e.client, opts)
}

func (e *StationboardEntity) Data(args ...any) any {
...
func (e *StationboardEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Stationboard; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *StationboardEntity) DataTyped(data ...Stationboard) Stationboard {
	if len(data) > 0 {
		return typedFrom[Stationboard](e.Data(asMap(data[0])))
	}
	return typedFrom[Stationboard](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Stationboard (all fields
// optional at the wire level).
func (e *StationboardEntity) MatchTyped(match ...Stationboard) Stationboard {
	if len(match) > 0 {
		return typedFrom[Stationboard](e.Match(asMap(match[0])))
	}
	return typedFrom[Stationboard](e.Match())
}
...
func (e *StationboardEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *StationboardEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *StationboardEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// StationboardListMatch and returns []Stationboard. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *StationboardEntity) ListTyped(reqmatch StationboardListMatch, ctrl map[string]any) ([]Stationboard, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Stationboard](res), nil
}



func (e *StationboardEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *StationboardEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *StationboardEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *StationboardEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
