...
func NewConnectionEntity(client *core.TransportSDK, entopts map[string]any) *ConnectionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ConnectionEntity) GetName() string { return e.name }
...
func (e *ConnectionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ConnectionEntity) Deleted() bool {
	return e.deleted
}


func (e *ConnectionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewConnectionEntity(e.client, opts)
}

func (e *ConnectionEntity) Data(args ...any) any {
...
func (e *ConnectionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Connection; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ConnectionEntity) DataTyped(data ...Connection) Connection {
	if len(data) > 0 {
		return typedFrom[Connection](e.Data(asMap(data[0])))
	}
	return typedFrom[Connection](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Connection (all fields
// optional at the wire level).
func (e *ConnectionEntity) MatchTyped(match ...Connection) Connection {
	if len(match) > 0 {
		return typedFrom[Connection](e.Match(asMap(match[0])))
	}
	return typedFrom[Connection](e.Match())
}
...
func (e *ConnectionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ConnectionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ConnectionEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ConnectionListMatch and returns []Connection. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ConnectionEntity) ListTyped(reqmatch ConnectionListMatch, ctrl map[string]any) ([]Connection, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Connection](res), nil
}



func (e *ConnectionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ConnectionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ConnectionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ConnectionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
