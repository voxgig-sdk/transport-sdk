...
func NewLocationEntity(client *core.TransportSDK, entopts map[string]any) *LocationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LocationEntity) GetName() string { return e.name }
...
func (e *LocationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LocationEntity) Deleted() bool {
	return e.deleted
}


func (e *LocationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLocationEntity(e.client, opts)
}

func (e *LocationEntity) Data(args ...any) any {
...
func (e *LocationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Location; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LocationEntity) DataTyped(data ...Location) Location {
	if len(data) > 0 {
		return typedFrom[Location](e.Data(asMap(data[0])))
	}
	return typedFrom[Location](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Location (all fields
// optional at the wire level).
func (e *LocationEntity) MatchTyped(match ...Location) Location {
	if len(match) > 0 {
		return typedFrom[Location](e.Match(asMap(match[0])))
	}
	return typedFrom[Location](e.Match())
}
...
func (e *LocationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LocationEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *LocationEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LocationListMatch and returns []Location. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *LocationEntity) ListTyped(reqmatch LocationListMatch, ctrl map[string]any) ([]Location, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Location](res), nil
}



func (e *LocationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LocationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LocationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LocationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
