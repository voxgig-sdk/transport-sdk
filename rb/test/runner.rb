...
module TransportTestRunner
  ...
  def self.env_override(m)
    live = getenv("TRANSPORT_TEST_LIVE")
    override = getenv("TRANSPORT_TEST_OVERRIDE")
    ...
    explain = getenv("TRANSPORT_TEST_EXPLAIN")
    m["TRANSPORT_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = TransportTestRunner
Helpers = TransportHelpers
Vs = VoxgigStruct
