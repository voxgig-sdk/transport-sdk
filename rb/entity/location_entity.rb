...
class LocationEntity
  ...
  def make
    opts = @_entopts.dup
    LocationEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [LocationListMatch, Hash, nil] match filter (any subset of
  #   Location fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Location>, Array] the matching Location items; raises TransportError on failure
