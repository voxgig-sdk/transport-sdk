...
class ConnectionEntity
  ...
  def make
    opts = @_entopts.dup
    ConnectionEntity.new(@_client, opts)
  end
  ...
  # @return [Connection, Hash] the current Connection data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Connection fields)
  def match_get
  ...
  #
  # @param reqmatch [ConnectionListMatch, Hash, nil] match filter (any subset of
  #   Connection fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Connection>, Array] the matching Connection items; raises TransportError on failure
